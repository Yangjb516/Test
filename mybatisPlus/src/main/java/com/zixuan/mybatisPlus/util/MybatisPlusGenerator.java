package com.zixuan.mybatisPlus.util;
...
/**
 * author yjb
 * create 2022/3/3 - 16:01
 */
public class MybatisPlusGenerator {
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSOWRD = "root";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.zixuan.mybatisPlus";
//    private static final String MODULE_NAME = "book";
    private static final String MODULE_NAME = "";

    // 表名，多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"pub_books"};
    ...
    public static void main(String[] args) {
        ...
        fastAutoGenerator.globalConfig(globalConfigBuilder -> globalConfigBuilder.disableOpenDir()
                .outputDir("mybatisPlus\\src\\main\\java").author("yjb").commentDate("yyyy-MM-dd").dateType(DateType.TIME_PACK));
        ...
        fastAutoGenerator.packageConfig(packageConfigBuilder -> packageConfigBuilder.parent(PACKAGE_NAME)
                ...
                .pathInfo(Collections.singletonMap(OutputFile.xml, "mybatisPlus\\src\\main\\resources\\mapper")));
        ...
        // 全局主键类型为None
        // formatFileName("%sEntity"):实体名称格式化为XXXEntity
        fastAutoGenerator.strategyConfig(strategyConfigBuilder -> strategyConfigBuilder.entityBuilder()
                ...
                .columnNaming(NamingStrategy.underline_to_camel).idType(IdType.NONE));
